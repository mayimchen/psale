...
<html>
	<head>
		...
		<script language="javascript" src="js/delwuliao.js"></script>
	</head>
	<body>
		<h3 align="center">
			出库页面
		...
		<hr />
		<div align="center">
			<form onsubmit="return checksubmit();" action="delwuliaoaction.action">
				<table cellpadding="0" cellspacing="0" bgcolor="#e7eef8" width="600"
					...
					<tr>
						...
						<td>
					<input type="text" id="outnum" name="outnum" onblur="checkoutnum(this)"/>
